...
def load_data(dataset_str):
    ...
    for i in range(len(names)):
        with open("/home/hdou/model/H-GCN-master/tensorflow_code/data/ind.{}.{}".format(dataset_str, names[i]), 'rb') as f:
    ...
    test_idx_reorder = parse_index_file("/home/hdou/model/H-GCN-master/tensorflow_code/data/ind.{}.test.index".format(dataset_str))
...
#    logging.info("Reading graph from metis...")
    with open("/home/hdou/model/H-GCN-master/tensorflow_code/data/ind.{}.{}".format(dataset_name, 'graph'), 'rb') as f:
        if sys.version_info > (3, 0):
